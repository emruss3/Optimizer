-- =====================================================
-- PERFORMANCE OPTIMIZATION - Prevent statement timeouts
-- =====================================================

-- Drop and recreate the function with performance optimizations
...
SELECT 'Testing the optimized get_parcel_buildable_envelope function...' AS status;

-- Test with parcel 552298 (the one the app is trying to load)
SELECT * FROM public.get_parcel_buildable_envelope(552298);

SELECT 'Performance optimization completed!' AS final_status;
