-- =====================================================
-- Get Parcel Geometry for Site Planner
-- Date: 2025-01-15
-- Description: Extract parcel geometry in format suitable for site planning
-- =====================================================
...
-- SELECT * FROM get_parcel_geometry_for_siteplan(12345);
-- 
-- -- Use in site planner to get properly projected coordinates
-- -- The geometry_local field will have coordinates in meters (Web Mercator)
-- -- The app should convert these to feet and normalize for SVG rendering
-- =====================================================
