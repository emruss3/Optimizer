...
function $() {
  for (var n2, u3, t2, r2, o2, f3, c2, s2 = 1; i.length; ) i.length > s2 && i.sort(e), n2 = i.shift(), s2 = i.length, n2.__d && (t2 = void 0, o2 = (r2 = (u3 = n2).__v).__e, f3 = [], c2 = [], u3.__P && ((t2 = d({}, r2)).__v = r2.__v + 1, l.vnode && l.vnode(t2), O(u3.__P, t2, r2, u3.__n, u3.__P.namespaceURI, 32 & r2.__u ? [o2] : null, f3, null == o2 ? S(r2) : o2, !!(32 & r2.__u), c2), t2.__v = r2.__v, t2.__.__k[t2.__i] = t2, N(f3, t2, c2), t2.__e != o2 && C(t2)));
  $.__r = 0;
}
function I(n2, l2, u3, t2, i3, r2, o2, e2, f3, c2, s2) {
  var a2, h2, y2, w2, d2, g2, _2 = t2 && t2.__k || v, m2 = l2.length;
  for (f3 = P(u3, l2, _2, f3, m2), a2 = 0; a2 < m2; a2++) null != (y2 = u3.__k[a2]) && (h2 = -1 == y2.__i ? p : _2[y2.__i] || p, y2.__i = a2, g2 = O(n2, y2, h2, i3, r2, o2, e2, f3, c2, s2), w2 = y2.__e, y2.ref && h2.ref != y2.ref && (h2.ref && B(h2.ref, null, y2), s2.push(y2.ref, y2.__c || w2, y2)), null == d2 && null != w2 && (d2 = w2), 4 & y2.__u || h2.__k === y2.__k ? f3 = A(y2, f3, n2) : "function" == typeof y2.type && void 0 !== g2 ? f3 = g2 : w2 && (f3 = w2.nextSibling), y2.__u &= -7);
  return u3.__e = d2, f3;
}
...
var ScreenshotWidget = class _ScreenshotWidget extends WidgetImpl {
  ...
  onRenderHTML() {
    ...
    if (!element)
      return;
    G(u2(IconButton, { className: "deck-widget-camera", label: this.props.label, onClick: this.handleClick.bind(this) }), element);
  }
  handleClick() {
...
var ResetViewWidget = class _ResetViewWidget extends WidgetImpl {
  ...
  onRenderHTML() {
    ...
    if (!element)
      return;
    G(u2(IconButton, { className: "deck-widget-reset-focus", label: this.props.label, onClick: this.handleClick.bind(this) }), element);
  }
  handleClick() {
    var _a;
