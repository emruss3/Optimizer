...
// node_modules/@deck.gl/aggregation-layers/dist/screen-grid-layer/screen-grid-layer-uniforms.js
var uniformBlock3 = (
  /* glsl */
...
// node_modules/@deck.gl/aggregation-layers/dist/screen-grid-layer/bin-options-uniforms.js
var uniformBlock4 = (
  /* glsl */
...
// node_modules/@deck.gl/aggregation-layers/dist/common/utils/scale-utils.js
...
// node_modules/@deck.gl/aggregation-layers/dist/hexagon-layer/hexbin.js
...
// node_modules/@deck.gl/aggregation-layers/dist/hexagon-layer/hexagon-cell-layer-vertex.glsl.js
...
// node_modules/@deck.gl/aggregation-layers/dist/hexagon-layer/hexagon-layer-uniforms.js
var uniformBlock5 = (
  /* glsl */
...
// node_modules/@deck.gl/aggregation-layers/dist/hexagon-layer/hexagon-cell-layer.js
var HexagonCellLayer = class extends column_layer_default {
  getShaders() {
...
// node_modules/@deck.gl/aggregation-layers/dist/hexagon-layer/bin-options-uniforms.js
var uniformBlock6 = (
  /* glsl */
  `uniform binOptionsUniforms {
...
var HexagonLayer = class extends aggregation_layer_default {
  ...
  _updateBinOptions() {
    ...
    if (bounds && Number.isFinite(bounds[0][0])) {
      ...
      viewport = viewport.isGeospatial ? new ViewportType({ longitude: centroid[0], latitude: centroid[1], zoom: 12 }) : new viewport_default({ position: [centroid[0], centroid[1], 0], zoom: 12 });
...
var GridLayer = class extends aggregation_layer_default {
  ...
  renderLayers() {
    ...
    const LinesSubLayerClass = this.getSubLayerClass("lines", path_layer_default);
...
// node_modules/@deck.gl/aggregation-layers/dist/grid-layer/grid-cell-layer-vertex.glsl.js
...
// node_modules/@deck.gl/aggregation-layers/dist/grid-layer/grid-layer-uniforms.js
var uniformBlock8 = (
  /* glsl */
...
// node_modules/@deck.gl/aggregation-layers/dist/grid-layer/grid-cell-layer.js
...
// node_modules/@deck.gl/aggregation-layers/dist/grid-layer/bin-options-uniforms.js
var uniformBlock9 = (
  /* glsl */
  `uniform binOptionsUniforms {
  vec2 cellOriginCommon;
...
var AggregationLayer2 = class extends composite_layer_default {
...
export {
  ...
  WebGLAggregator,
  aggregation_layer_default as _AggregationLayer
};
