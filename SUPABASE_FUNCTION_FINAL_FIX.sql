-- =====================================================
-- FINAL FUNCTION FIX - Complete and corrected version
-- =====================================================
...
BEGIN
  ...
  -- Get zoning data for setbacks using the parcel's geoid
  SELECT 
...
-- Test the function
SELECT 'Testing the corrected get_parcel_buildable_envelope function...' AS status;

-- Test with parcel 661807
SELECT * FROM public.get_parcel_buildable_envelope(661807);

SELECT 'Function fix completed successfully!' AS final_status;
